...
const PokemonList = () => {
  ...
  async function downloadPokemon() {
    ...
    // We get the array of pokemons

    const pokemonResults = response.data.results;
    console.log(response)

    // iterating over the array of pokemons, and using their url, to create an array of promises that will download these 20 pokemons
